...
FhcBrowserListener.prototype = {
  ...
  init: function () {
    ...
    this._observerService.addObserver(this, "sessionstore-state-write-complete", false);
   ...
   */
  destroy: function() {
    this._observerService.removeObserver(this, "sessionstore-state-write-complete");
